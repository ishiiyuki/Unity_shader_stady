Shader "Aktsk/Chara/Toon + Lambert + RimLight + Outline + Transparent"
{
    Properties
    {
		...
		_Transparent("Transparent", Int) = 1
	}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                return (_Transparent > 0) ? float4(0, 0, 0, 0) : _LineColor;
            }
            ENDCG
        }
        ...
        Pass
        {
            ...
            fixed4 frag(vert_out i) : SV_Target
            {
                ...
                return float4(vDiffuse * _AmbColor.rgb, (_Transparent > 0) ? 0 : vAlbedo.a);
    ...
    Fallback "VertexLit"
    CustomEditor "NanaiCharaRimLightOutlineTransparentShaderEditor"
}